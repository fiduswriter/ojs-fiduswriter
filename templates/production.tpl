 ...
 * Inset FidusWriter revision grid
 *}
...
<div id="production">
	...
	<div class="pkp_workflow_content">
		{* Insert FidusWriter revision grid *}
        {include
        file="../../../plugins/generic/fidusWriter/templates/grid/fiduswriterRevision.tpl"
        title="submission.finalDraft"
        revisionUrl=$revisionUrl
        }
		<hr style="height: 1rem; border: 0 none; background: transparent none; margin: 0; padding: 0;">
